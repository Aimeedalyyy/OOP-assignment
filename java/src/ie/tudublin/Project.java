...
public class Project extends PApplet
{
    ...
    public void setup()
    {
        ...
        //audio files
        banjo = minim.loadFile("Banjo.wav" , 1024); //1024 is the size of the buffer we are using 
        boathorn = minim.loadFile("boathorn.mp3", 1024);
        drums = minim.loadFile("drums.mp3", 1024);
        guitar = minim.loadFile("Guitar.wav", 1024);
        whistle = minim.loadFile("whistle.mp3" , 1024);
